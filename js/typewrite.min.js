...
$('#typewriteText').typewrite({
  actions: [
    {type: 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Donec aliquet, risus sed imperdiet imperdiet, nibh eros aliquam nulla, varius aliquet dui nisi sit amet ipsum. Aliquam erat volutpat. '},
    {type: '<br>'},
    {type: 'Donec massa leo, sodales non faucibus vitae, ultricies quis purus. Vestibulum blandit orci ut porta ultrices. Integer tincidunt vulputate condimentum. Duis posuere turpis quis mauris auctor, at vehicula arcu rutrum. Morbi ornare pulvinar elit at posuere. Maecenas semper gravida nunc sit amet molestie. Phasellus malesuada placerat vulputate. Interdum et malesuada fames ac ante ipsum primis in faucibus. Sed sed molestie enim, sit amet viverra elit.'},
    {delay: 1500},
    {remove: {num: 1, type: ' Phasellus tellus lacus, tincidunt et elementum pulvinar, fringilla at ligula.'}},
    {select: {from: 11, to: 16}},
    {delay: 2000},
    {remove: {num: 5, type: ' Curabitur venenatis pharetra vestibulum. Mauris ultricies leo nibh, non porta arcu mollis molestie. Curabitur tincidunt dolor magna, non fringilla mauris placerat vel. Etiam elementum neque lacinia, vestibulum felis eu, tristique arcu. Duis pellentesque mollis ex, eget elementum orci lobortis vitae.'}},
    {delay: 300},
    {type: 'lcome to `typewrite`. '},
    {type: '<br>'},
    {type: 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Curabitur venenatis pharetra vestibulum. Mauris ultricies leo nibh, non porta arcu mollis molestie. Curabitur tincidunt dolor magna, non fringilla mauris placerat vel. Etiam elementum neque lacinia, vestibulum felis eu, tristique arcu. Duis pellentesque mollis ex, eget elementum orci lobortis vitae.'}
  ]
});
